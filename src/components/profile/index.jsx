  ...
  return (
    <div className="flex flex-col w-1/5 overflow-y-auto bg-[#F1F5F9] rounded-md mr-2 mt-2 shadow-md">
      <div className="flex gap-2 items-center border-b-2 p-4">
        <img
          src={dataContext.collectedData.profileImage}
          alt="user"
          className="object-cover rounded-full w-16 h-16"
        />
        <div className="flex flex-col">
          <span className="text-lg font-bold">
            {dataContext.collectedData.userName}
          </span>
      ...
      <div className="flex flex-col break-all p-4">
        ...
        <div className="flex flex-col mt-4 text-[#94A3B8]">
          <div className="flex min-w-fit gap-3 items-center">
            ...
            <span>{dataContext.collectedData.phone}</span>
          </div>
          <div className="flex min-w-fit gap-3 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span>{dataContext.collectedData.email}</span>
          </div>
          <div className="flex min-w-fit gap-3 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span>{dataContext.collectedData.userCountry}</span>
          </div>
          <div className="flex min-w-fit gap-3 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span>{dataContext.collectedData.timezone}</span>
          </div>
        </div>
      </div>
