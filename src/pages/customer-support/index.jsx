    ...
    axios
      ...
      .then((response) => {
        if (response.data.response?.length > 0) {
          ...
          setIntervalId(
            setInterval(() => {
              getMessages(response.data.last_room_details._id);
            }, 5000)
          );
        } else {
          clearInterval(intervalId);
      ...
      <div className="flex w-11/12 ">
        <div className="flex flex-col w-4/5 pt-6 justify-evenly">
          ...
          <div className="flex border h-4/5">
            <div className="w-1/3 border-r-2 p-3 overflow-auto text-center">
                            ...
                            >
                              {
                                <Message
                                  ...
                                  style={
                                    message.side
                                      ? "bg-blue-600 rounded-s-2xl rounded-br-2xl"
                                      : "bg-gray-300 rounded-e-2xl rounded-bl-2xl"
                                  }
                                />
                              }
                            </div>
