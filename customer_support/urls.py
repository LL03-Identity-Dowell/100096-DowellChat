...
urlpatterns = [
    ...
    path('send/<int:room_id>/', views.send_message_api, name= 'send_message'),
    path('send_message/<int:room_id>/', views.send_message_api, name='send_message'),
    ...
    path('send_message/<int:room_id>/', views.send_msg_api_3, name= 'send_message_3'),
