            ...
            <div className="mt-5">
                {
                    ...
                    })=> <p className='mb-3' onClick={(event)=>console.log(event.currentTarget.value)}>{session_id}</p>)
                }
            </div>
            <div className="">
                <form action="">
                <input type="text" placeholder="Type here" className="p-2 rounded-md border-gray-300" />
                    <button></button>
                </form>
            </div>
