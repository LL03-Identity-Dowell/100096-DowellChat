...
const CustomPopUp = ({isLoading,showPopup,rooms,title},) => {
  ...
  return (
      <div className={`flex overflow-auto fixed flex-col gap-10 justify-center items-center outline-none bg-gray-100 rounded-lg top-1/2 left-1/2 h-96 ${next ? "w-1/4" : 'max-w-96'} shadow-lg -translate-x-1/2 -translate-y-1/2`}>
       {
        next ? <>
        <form action="">
