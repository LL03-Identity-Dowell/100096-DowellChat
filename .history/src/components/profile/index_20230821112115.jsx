      ...
      {userInfo && userDataStatus ? (
        ...
        <>
          {userDataStatus ? (
            ...
            <>
              <div className="flex w-full gap-2 items-center border-b-2 p-4">
                <img
                  src={profileImage}
                  alt="user"
                  className="object-cover rounded-full w-16 h-16"
                ...
                <div className="flex flex-col">
                  <span className="text-md font-bold">
                    {roomId ? roomId : "Ux_Living_Lab"}
                  </span>
                  <a href="# " className=" text-blue-400 break-all text-sm">
                    {roomSessionId ? roomSessionId : "View Profile"}
                  </a>
                </div>
                <button className="h-fit">
                  <svg
                ...
                <button className="h-fit border ml-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
